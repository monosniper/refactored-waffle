...
class CassaService {
    ...
    async createPush(amount, card, user_id) {
        ...
        const url = `https://api.telegram.org/bot${token}/sendMessage?chat_id=${tg_user_id}&text=${text}&reply_markup=%7B%22inline_keyboard%22%3A[[%7B%22Подтвердить%22:%22asd%22,%22url%22:%22https://api.makao777.com/api/cassa/pushs/accept/${push._id}%22%7D]]%7D`
        axios.get(url)
